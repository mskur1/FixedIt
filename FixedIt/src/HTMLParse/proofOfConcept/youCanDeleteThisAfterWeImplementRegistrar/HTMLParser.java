...
public class HTMLParser {
	...
	public static void main(String[] args) {
		String sourceHTML="";
		try {
			sourceHTML=getUrlSource("http://ycpweb.ycp.edu/schedule-of-classes/index.html?term=201520&stype=A&dmode=D&dept=CS_12");
		} catch (IOException e) {
			e.printStackTrace();
		}
		...
		//Document doc=Jsoup.parse(sourceHTML);
		 ...
		 ArrayList<Course> courses=parseCSVLines(lines);
	...
	private static ArrayList<Course> parseCSVLines(String[] lines){
